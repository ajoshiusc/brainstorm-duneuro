...
%% improve Colin27 adult human brain atlas mesh using brainsuite surfaces, fangq, 2011/02/02-02/05
...
fprintf(1, '===========================================  Loading brainsuite surfaces  ====\n');

s=readdfs('/home/ajoshi/BrainSuite19a/svreg/BrainSuiteAtlas1/mri.left.inner.cortex.dfs');
wln=s.vertices; wlf=s.faces;
s=readdfs('/home/ajoshi/BrainSuite19a/svreg/BrainSuiteAtlas1/mri.right.inner.cortex.dfs');
wrn=s.vertices; wrf=s.faces;

s=readdfs('/home/ajoshi/BrainSuite19a/svreg/BrainSuiteAtlas1/mri.left.pial.cortex.dfs');
pln=s.vertices; plf=s.faces;

s=readdfs('/home/ajoshi/BrainSuite19a/svreg/BrainSuiteAtlas1/mri.right.pial.cortex.dfs');
prn=s.vertices; prf=s.faces;
...
v=load_nii_BIG_Lab('/home/ajoshi/BrainSuite19a/svreg/BrainSuiteAtlas1/mri.label.nii.gz');
%fid=fopen('orig/atlas.img','rb');
head= v.img;%fread(fid,inf,'uchar');
%fclose(fid);
...
%% one should either use the following 3 lines, or comment out them and use the 4th line
pialv=surf2vol(pialn,pialf,xi,yi,zi);
wmv=surf2vol(wmn,wmf,xi,yi,zi);
save brainsuite_volumes pialv wmv
% load brainsuite_volumes  %% use load to avoid repetitive meshing of pial and wm
...
%% diffvol stores the original image - brainsuite volume = cerebellum volume
...
%% extract the ventricle surface from MNI atlas inside the brainsuite white matter
...
'The gray/white matter surfaces were created by Katherine Perdue [3] with brainsuite [4]\n\n' ...
'Please refer to ''Qianqian Fang, "Mesh-based Monte Carlo method using fast ray-tracing in Plucker ' ...
'coordinates," Biomed. Opt. Express 1(1), 165-175 (2010)'' for details.\n\n' ...
'Format: \n' ...
